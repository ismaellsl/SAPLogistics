sap.ui.core.mvc.Controller.extend("Vehicle.view.Master", {
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("VehicleInscription", sap.ui.model.FilterOperator.Contains, searchString)];
		}
		// Update list binding
